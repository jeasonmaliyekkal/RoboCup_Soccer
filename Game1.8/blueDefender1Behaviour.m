function [blue_striker_T, blue_defender1_T,  ball] =  blueDefender1Behaviour(blue_striker_T, blue_defender1_T, ball, ballPlotT, TOLERANCE, PLAYER_GAP, TIME_STEP, OMEGA, defenderPlotT, positionMatrixR,positionMatrixB)
