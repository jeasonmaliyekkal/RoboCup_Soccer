...
[pass, n, x, y, delta] = readat('data.xlsx','sheet1', [1:25]);
h = plotfield(0,x,y,n,pass);
for t = 0:size(dat,1)-25
   [pass, n, x, y, delta] = readat('data.xlsx','sheet1', [1:25]+t);
...
if nargin==6
    ...
    set(h(2), 'String',[num2str(t),'th/rd pass network unit']);
...
h(2) = title([num2str(t),'th/rd pass network unit']);
